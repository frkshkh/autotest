...
public class GNB_Diff_Channel {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get(baseUrl + "rings?cid=psdrm-&resetChannel=true");
		Thread.sleep(2000);
		...
		// now start open catalog page URLs present in GNB desktop including open page-2 from pagination opptions. 
		...
		jse.executeScript("window.scrollBy(0,750)"); 
		Thread.sleep(2000);
		wait.until(ExpectedConditions.invisibilityOfElementWithText(By.id("newsletter-validate-detail"), "Become a preferred subscriber and get a special offer on your first purchase.")); 
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "rings/colored-diamond-rings/enhanced-black-diamond?gnb=rings-stone-enhanced_black_diamond");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "pendants/colored-diamond-necklace-pendants/enhanced-blue-diamond?gnb=necklaces-stone-enhanced_blue_diamond");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "pendants/colored-diamond-necklace-pendants/enhanced-black-diamond?gnb=necklaces-stone-enhanced_black_diamond");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "earrings/colored-diamond-earrings/enhanced-blue-diamond?gnb=earrings-stone-enhanced_blue_diamond");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "earrings/colored-diamond-earrings/enhanced-black-diamond?gnb=earrings-stone-enhanced_black_diamond");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "engagement-rings/colored-diamond-engagement-rings/enhanced-blue-diamond-engagement?gnb=engagement-stone-enhanced_blue_diamond");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "engagement-rings/colored-diamond-engagement-rings/enhanced-black-diamond-engagement?gnb=engagement-stone-enhanced_black_diamond");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "wedding-rings/wedding-bands?filterable_metal_types=white--gold&order=position&dir=asc&gnb=wedding-metal-white_gold");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "wedding-rings/wedding-bands?filterable_metal_types=yellow--gold&order=position&dir=asc&gnb=wedding-metal-yellow_gold");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "wedding-rings/wedding-bands?filterable_metal_types=rose--gold&order=position&dir=asc&gnb=wedding-metal-rose_gold");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "wedding-rings/wedding-bands?filterable_metal_types=two--tone--gold&order=position&dir=asc&gnb=wedding-metal-two_tone_gold");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "wedding-rings/wedding-bands?filterable_metal_types=platinum&order=position&dir=asc&gnb=wedding-metal-platinum");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "wedding-rings/wedding-bands?filterable_metal_types=silver&order=position&dir=asc&gnb=wedding-metal-silver");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "collection/high-jewelry/certified-gemstone?icid=topnavimages|collections|02062018&gnb=collection-banner");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "birthstone-jewelry/february-birthstone-amethyst-jewelry?gnb=gifts-birthstone-feb_amethyst");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "birthstone-jewelry/march-birthstone-aquamarine-jewelry?gnb=gifts-birthstone-mar_aquamarine");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "birthstone-jewelry/september-birthstone-sapphire-jewelry?gnb=gifts-birthstone-sep_sapphire");	
		...
		logger.info(" Page-2 Finish " + driver.getCurrentUrl()); 
		driver.get(baseUrl + "birthstone-jewelry/december-birthstone-tanzanite-jewelry?gnb=gifts-birthstone-dec_tanzanite");	
